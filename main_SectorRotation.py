...
df_sectorBottoms_avg_dayswrBottom = df_bottoms_US.groupby('sector')['days_wrBottom'].mean() #group by sectors to get the average days of the sector bottom w/r S&P500 2022 market bottom
print(df_sectorBottoms_avg_dayswrBottom)

df_industryBottoms_avg_dayswrBottom = df_bottoms_US.groupby('industry')['days_wrBottom'].mean() #group by industry to get the average days of the industry bottom w/r S&P500 2022 market bottom
print(df_industryBottoms_avg_dayswrBottom)
